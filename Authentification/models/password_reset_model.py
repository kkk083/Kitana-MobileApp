...
class PasswordReset:
    ...
    def is_valid(self) -> bool:
        ...
        if self.expires_at:
            # G̩rer la comparaison naive/aware
            expires = self.expires_at
            if expires.tzinfo is not None:
                # Si expires_at a une timezone, on la retire pour comparer avec datetime.now() (qui est naif)
                # Cela suppose que la date a ̩t̩ stock̩e correctement (en heure locale)
